...
public class AudioAdaphter extends RecyclerView.Adapter<AudioAdaphter.viewHolder> implements Filterable {
    ...
    private ViewAudioList viewAudioList;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AudioAdaphter.viewHolder(view, viewAudioList);
    }

    public AudioAdaphter(Context context, ArrayList<VideoContentModel> arrayList) {
        this.arrayList = arrayList;
        this.context = context;
        this.arrayListFull = new ArrayList<>(arrayList);
        viewAudioList = (ViewAudioList) context;
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, final int position) {
        ...
        Glide.with(context).load(R.drawable.ic_009_music).

                into(holder.playvideo);
        holder.videoView.setVisibility(View.GONE);
        if (!viewAudioList.isaction_mode && !viewAudioList.isedit_mode) {
        ...
        } else if (!viewAudioList.isaction_mode && viewAudioList.isedit_mode) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        if (!viewAudioList.isaction_mode) {
        ...
        holder.itemView.setOnLongClickListener(viewAudioList);
    ...
    public class viewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public viewHolder(@NonNull View itemView, ViewAudioList viewAudioList) {
            super(itemView);
        ...
        @Override
        public void onClick(View v) {
            viewAudioList.prepareselection(v, getAdapterPosition());
        }
    }
